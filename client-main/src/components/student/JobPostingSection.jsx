...
const jobs = [
	...
	},
	{
		...
		description:
			'Design, implement, and manage cloud-based systems and services with a focus on scalable architecture and performance.',
	...
	},
	{
		...
		description:
			'Monitor, analyze, and respond to cybersecurity threats using state-of-the-art tools and incident response practices.',
	...
	},
	{
		...
		role: 'Data Scientist',
		description:
			'Analyze large datasets to generate business insights and build predictive models to support data-driven decisions.',
	...
	},
	{
		...
		description:
			'Build and automate infrastructure for cloud platforms with a focus on continuous integration and deployment pipelines.',
	...
	},
	{
		...
		description:
			'Design and implement secure network infrastructures and provide real-time monitoring of potential cyber threats.',
...
const JobPostingSection = () => (
	<section className="section__container job__container" id="job">
		...
		<p className="job-subheading">
			...
			Cybersecurity, and more — across top US-based companies.
		</p>
